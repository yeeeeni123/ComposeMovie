package com.yeen.designsystem.dialog.component.content
...
import com.yeen.designsystem.util.getAnnotatedText
...
fun ColumnScope.StarRatingBar(score: Float) {
    Card(
        ...
        Box(
            ...
            val foregroundColor = colorResource(id = R.color.brightRed).toArgb()
            ...
            //Jetpack compose 에서 사용할수 있게 해주는 함수
            AndroidView(
                modifier = Modifier
                    .wrapContentWidth()
